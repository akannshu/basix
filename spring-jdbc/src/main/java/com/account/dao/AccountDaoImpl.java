...
public class AccountDaoImpl implements AccountDao {
	...
	public List<Account> getAllAccounts() {
		...
		try {
			...
			System.out.println("In the Get Account By Id Mentod");
	...
	public void update(Account account) {
		...
		try {
			Connection connection = dataSource.getConnection();
			PreparedStatement pstmt = connection.prepareStatement("UPDATE account SET amount=? WHERE id=?");
			pstmt.setDouble(1, account.getBalance());
			pstmt.setInt(2, account.getId());
			pstmt.executeUpdate();
			System.out.println("In the Update Mentod");
	...
	public void delete(Integer id) {
		try {
			...
			pstmt.setInt(1, id);
			pstmt.executeUpdate();
			System.out.println("In the Delete Mentod");
	...
	public void insert(Account account) {
		...
		try {
			...
			pstmt.executeUpdate();
			System.out.println("In the Insert Mentod");
